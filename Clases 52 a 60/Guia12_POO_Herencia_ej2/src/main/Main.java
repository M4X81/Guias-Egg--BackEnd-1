...
public class Main {
    ...
    public static void main(String[] args) {
        LavadoraService lavadoraServ = new LavadoraService();
        TelevisorService televisorServ = new TelevisorService();
        Lavadora lavadora = lavadoraServ.crearLavadora();
        Televisor tele = televisorServ.crearTelevisor();
        lavadoraServ.precioFinal(lavadora);
        televisorServ.precioFinal(tele);
