...
public class Curso {
    ...
    public Curso(String nombreCurso, int cantidadHorasPorDia, int cantidadDiasPorSemana, boolean turnoManiana, boolean turnoTarde, double precioPorHora, String[] alumnos) {
